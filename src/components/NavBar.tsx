        ...
        <>
            <header className="w-full h-full bg-[#ff3b3c] px-5 pt-5 flex flex-col items-center md:h-[150px]">
                <div className="w-full flex flex-col justify-between items-center flex-grow-[1] sm:flex-row  xl:w-[1080px]">
                    <Link
                        to="/"
                        className=" w-[50%] flex items-center justify-center flex-grow-[1] sm:w-[33%] sm:justify-start"
                    >
                        <img
                            className="h-[50px]"
                ...
                <nav
                    id="navbar"
                    className="w-full py-[15px] px-[20px] bg-[#ff3b3c] list-none text-sm text-center sm:flex sm:flex-row sm:items-start xl:w-[1080px]  sm:justify-between "
                >
